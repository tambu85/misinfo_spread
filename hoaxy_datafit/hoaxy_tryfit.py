...
#DATA FITTING
#mf_seg
param0=[0.1,0.5, 7000, 0.5, 0.1, 0.1, 0.8, 10]
param_bounds =([0.001,0, 1000, 0.1, 0, 0, 0.5, 5], [10.,1., 2000000, 0.9, 0.9, 0.2, 1., 15])
...
pylab.figure()
pylab.axis([0.0,max(t_empirical), 0, net_size / 2])
ax = pylab.gca()
...
pylab.savefig('hoaxy_mexico_tryfit.pdf', format='pdf')
